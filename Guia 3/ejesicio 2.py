...
def ListadeArchivos(RutaCarpeta, extension):
    """
    Lista los archivos con una extensión específica en la carpeta dada y sus subcarpetas.
    ...
    """
    # Obtener todos los archivos en la carpeta dada y sus subcarpetas de manera recursiva
    archivos = [archivo for archivo in Path(RutaCarpeta).rglob(f"*{extension}") if archivo.is_file()]
    return archivos
...
print(f"Archivos con extensión {extension} en la carpeta {RutaCarpeta} y sus subcarpetas:")
